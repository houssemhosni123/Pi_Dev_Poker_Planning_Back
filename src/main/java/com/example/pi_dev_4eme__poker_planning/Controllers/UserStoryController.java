...
public class UserStoryController {
    ...
    @GetMapping("getUserStorys/{IdUserStory}")
    public UserStory getUserStoryById(@PathVariable Long IdUserStory) {
        return userStoryService.getUserStoryByIdUserStory(IdUserStory).orElse(null);
    }

    @PostMapping("/createUserStory")
    public UserStory createOrUpdateUserStory(@RequestBody UserStory userStory) {
        return userStoryService.saveOrUpdateUserStory(userStory);
    }
