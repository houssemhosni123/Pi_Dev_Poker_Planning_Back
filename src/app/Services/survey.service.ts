...
export class SurveyService {
  private apiUrl = environment.apiUrl; // Update this with your actual backend URL
  ...
  insertSurvey(body:any)
  {
    return this.http.post(`${this.apiUrl}/survey/responses`, body,{ responseType: 'text' })
